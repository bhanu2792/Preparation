...
public class GraphLongestPath {
	...
	public void add(GraphLongestPath g, int u, int v) {
		al[u].add(v);
		al[v].add(u);
	}
	...
	public static void main(String[] arg) throws NumberFormatException, IOException {
		...
		for (int t = 0; t < T; t++) {
			...
			GraphLongestPath g = new GraphLongestPath(vertics);
	...
	public static Pair BFS(GraphLongestPath g, int src) {
